                            ...
                            <section id="introduction" style="padding-top:30px">
                              <div class="login-wrap1">
                                <div class="login-html">
                                    <input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab">Order Summary</label>
                                    <input id="tab-2" type="radio" name="tab" class="sign-up"><label for="tab-2" class="tab"></label>
                                    <div class="login-form">
                                        <div class="sign-in-htm">
                                            <div class="group">
                                               <br> <label for="item" class="label1">Item</label>
                                                <label for="item" class="label1"><?php $it=$_POST['t_item'];  echo $it; ?></label>
                                            </div>
                                            <div class="group">
                                                <label for="quan" class="label1">Quantity</label>
                                               <label for="quan" class="label1"><?php $qua=$_POST['t_quanty'];  echo $qua; ?></label>
                                            </div>
                                            <div class="group">
